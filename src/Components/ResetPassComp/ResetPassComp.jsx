...
const ResetPassComp = () => {
  ...
  // Countdown logic for redirecting to the login page after password change
  if (flag === "changed") {
    setInterval(() => {
      setCount(count - 1);
    }, 1000);
  ...
  // useEffect for checking the validity of the reset string
  useEffect(() => {
    checkString(string)
      .then((res) => {
        if (res.status === 200) {
  ...
  const style2 = {
    ...
    width: "100vw",
    backgroundImage:
      "Url(https://cdn.dribbble.com/users/2121936/screenshots/4814257/media/3b45e4716422617a03088177f448e158.gif)",
  ...
  return (
    ...
    >
      {flag === "loading" ? (
        ...
        <img src={inv} alt="" style={{ width: "100vw" }} />
      ) : flag === "changed" ? (
        <div>
