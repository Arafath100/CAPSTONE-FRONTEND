...
import {
  ...
  getCredential,
  settingsAxios,
} from "../../Services/axios.jsx";
import {
  CircularLoadingWithMultipleCircle,
  ColorRingLoading,
} from "../../Services/loading.jsx";
import {
  errorToast,
  toastSuccess,
  toastWarn,
} from "../../Services/tostify.jsx";
...
const Settings = () => {
  ...
  // Alert component for initial instructions
  function AlertComp() {
    return (
  ...
  // useEffect for fetching initial credentials
  useEffect(() => {
    if (flag) {
      setFlag(false);
      getCredential()
  ...
  // Save and update credentials in the database
  const handleSave = (e) => {
    setLoadButton(false);
    e.preventDefault();
